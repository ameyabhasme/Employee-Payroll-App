...
public class EmployeePayrollController {
	...
	@PostMapping("/create")
	public ResponseEntity<ResponseDTO> addEmployeePayrolllData(@RequestBody EmployeeDTO employeeDTO){
		EmployeePayrollData empData = null;
	...
	public ResponseEntity<ResponseDTO> updateEmployeePayrolllData(@PathVariable ("id") int id, @RequestBody EmployeeDTO employeeDTO){
		EmployeePayrollData empData = null;
